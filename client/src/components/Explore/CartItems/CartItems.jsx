                            ...
                            <div key={index} className="cart-item mb-3 p-3 bg-dark rounded">
                                ...
                                <div className="d-flex justify-content-between align-item-center">
                                    <div className="d-flex align-items center gap-2">
                                        <button className="btn btn-danger btn-sm" disabled={item.quantity === 1} onClick={() => updateCartQuantity(item.itemId, item.quantity - 1)}>
                                            <i className="bi bi-dash"></i>
                                        </button>
                                        <span className="text-light">{item.quantity}</span>
                                        <button className='btn btn-primary btn-sm' onClick={() => updateCartQuantity(item.itemId, item.quantity + 1)}>
