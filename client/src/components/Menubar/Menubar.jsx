                    ...
                    </li>
                    {
                        isAdmin && (
                            <>
                                ...
                                <li className="nav-item">
                                    <Link className={`nav-link ${isActive('/categories') ? 'fw-bold text-warning' : ''}`} to="/categories">Categories</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className={`nav-link ${isActive('/users') ? 'fw-bold text-warning' : ''}`} to="/users">Users</Link>
                                </li>
                            </>
                        )
                    }
                    <li className="nav-item">
                        <Link className={`nav-link ${isActive('/orders') ? 'fw-bold text-warning' : ''}`} to="/orders">Orders</Link>
                    </li>
                </ul>
